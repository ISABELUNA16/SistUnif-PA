<?php
     ...
     * Clase que permite realizar operaciones de mantenimiento para la tabla "tb_unif_prenda"
     *
     * @author:    Rosmery Luna
     * @versión:    1.0
     * @fecha:      18/01/2017
    ...
    class ClsPrendas {
        ...
        */
        ...
        function fcConsultarPrendas($tipo, $id, $nombre)
        {
            $this->conectarBD();
            $arrayVal = null;
            $sqlProc  = "CALL sp_unif_consultarprendas(?,?,?)";
      ...
      /*function fcTransaccionPrendas($tipo, $id, $modulo)
        {
            $this->conectarBD();
            $arrayVal = null;
