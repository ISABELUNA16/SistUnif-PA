...
<?php
    ...
    class ClsUniformes {
        ...
        function fcConsultaruniformes($tipo, $id, $uniformes, $submenu)
        {
            $this->conectarBD();
            $arrayVal = null;
            $sqlProc  = "CALL sp_unif_consultarmenu(?,?,?,?)";
            $arrayVal = array($tipo, $id, $uniformes, $submenu);
            $arrayTip = array('i', 'i', 's', 'i');
            $refSP    = null;
