<?php
     ...
     * Clase que permite realizar operaciones de mantenimiento para la tabla "tb_unif_packuniformes"
     *
     * @author:    Rosmery Luna
     * @versión:    1.0
     * @fecha:      18/01/2017
    ...
    class ClsPack {
        ...
        */
        ...
        function fcConsultarPack($tipo, $id, $nombre)
        {
            $this->conectarBD();
            $arrayVal = null;
            $sqlProc  = "CALL sp_unif_consultarpack(?,?,?)";
      ...
      /*function fcTransaccionPack($tipo, $id, $modulo)
        {
            $this->conectarBD();
            $arrayVal = null;
